...
if(isset($_POST['save']))
{ 
	 $query="INSERT INTO teacher (name,ssd,mobile,dept)
	 VALUES('$name','$ssd','$no','$dept');";
...
<h3 align="center">TEACHER REGISTRATION</h3>
<fieldset>

<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
<table>
<tr><td>NAME</td><td>:<input type="text" name="name" ></td></tr>
<tr><td>SS-ID</td><td>:<input type="text" name="ssd" ></td></tr>
